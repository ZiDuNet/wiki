---
tags: [Hermes, Agent, Claude, GitHub, OpenAI, Skill, OpenClaw]
source: "小朱的学堂"
created: 2026-04-21
updated: 2026-05-10
category: Hermes
...
Nous Research 成立于 2023 年，诞生于 Discord 社区中 AI 爱好者的一次草根协作——一群人不满意大厂闭源模型的"内容审查"和"使用限制"，决定自己动手训练完全开放、不设藩篱的语言模型。创始人团队规模约 20 人，核心成员包括 CEO Jeffrey Quesnelle、共同创始人 Karan Malhotra，以及在开源社区极具影响力的 Teknium——他是 OpenHermes 数据集的创建者，该数据集是开源LLM微调领域最流行的训练数据之一，在 HuggingFace 上的下载量以百万计。顾问名单里甚至出现了 ...

## 相关实体

[[ChatGPT]], [[Claude-Code]], [[Claude]], [[Gemini]], [[GitHub]], [[Hermes]], [[OpenAI]], [[OpenClaw]], [[Qwen]], [[React]], [[微信]]

## 相关概念

[[AI-Agent]], [[MultiAgent]], [[微调]], [[浏览器自动化]], [[自进化系统]], [[记忆系统]]
