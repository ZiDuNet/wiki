---
tags: [Agent, MCP, GitHub, 飞书, Harness, Prompt, API, OpenAI]
...
接下来，让我们看一眼Moxt的工作界面：
最右侧是你的个人Agent，默认都叫momo；结合多Agents工作模式（详见...

## 相关实体

[[GitHub]], [[Harness]], [[Hermes]], [[MCP]], [[OpenClaw]], [[Stable-Diffusion]], [[钉钉]], [[飞书]]

## 相关概念

[[AI-Agent]], [[MultiAgent]], [[Vibe-Coding]]
