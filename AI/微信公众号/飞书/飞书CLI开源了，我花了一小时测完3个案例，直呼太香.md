> 📎 来源: [二哥狗腿子](https://mp.weixin.qq.com/s?__biz=MzUxNzAzMTU4OQ==&mid=2247486806&idx=1&sn=9e3d919d1ca5001fc2480907759daae1&chksm=f8f9db57efaf429d4ab0bd6658958efbbc03a184e3910313d29477cec19800a2bfcdc14aee60&mpshare=1&scene=1&srcid=04230L2MXlNsoj4xCT3yHK6g&sharer_shareinfo=9b3eb8cb465df226e05e5ec8aef41ea7&sharer_shareinfo_first=9b3eb8cb465df226e05e5ec8aef41ea7) | 时间: 2026-04-23 17:28
...
![](assets/img_854d51f3a378.png)

## 01、全局安装飞书 CLI

先搞清楚我们要装的是什么东西。

飞书 CLI 是飞书官方开源的命令行工具，托管在 GitHub 上，仓库地址是 
...
![](assets/img_f2bc197a0a01.png)

最终生成的词云图效果，说实话还挺震撼的。

![](assets/img_73227b5fcf20.png)
...
![](assets/img_6259eb69725a.png)

直接通过 docs +create 创建文档并导入。

![](assets/img_6a9faec5d6be.png)
...
![](assets/img_9992e4b131ce.png)

需要一点耐心。

![](assets/img_8cebde37ea2f.png)

内容是完全没问题的。

![](assets/img_d891c8964cc6.png)

最后 18 篇全部上传成功。就是上传时间比较久，毕竟面渣逆袭的含金量懂的都懂，每篇都是万字级别的硬核内容，图片也多，转换和上传都需要时间。

![](assets/img_240bb3351dfe.png)

上传完成后，我在飞书云空间里看到了整齐排列的 18 篇面渣逆袭，内容格式完全正确，图片也都正常显示。甚至连文章里的数学公式和流程图都正确渲染了，这一点让我非常惊喜。

我直接把文件夹分享出来，大家可以去看看：

> https://my.feishu.cn/wiki/CScqwBVyliWpRYkJEAWc9ouxnZf?from=from\_copylink

![](assets/img_86f0d0f204c6.png)
...
```
lark-cli auth statuslark-cli auth login --recommend
```
