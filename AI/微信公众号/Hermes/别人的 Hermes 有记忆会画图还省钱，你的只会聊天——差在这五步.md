> 📎 来源: [AI赋能说](https://mp.weixin.qq.com/s?__biz=MzI3NjE4OTAyMg==&mid=2247488599&idx=1&sn=753bf7222dda35bf010fd0cf2e61fc3e&chksm=ea2d26407da970f07d7c7717d51ee5bf0eefd023a30b8f1df3af394db7f59afe54e98b6760d0&mpshare=1&scene=1&srcid=0426Deh2dlBofJbTePxPiYxt&sharer_shareinfo=acb4310b4a344aba4fe25739b9ad859b&sharer_shareinfo_first=acb4310b4a344aba4fe25739b9ad859b) | 时间: 2026-04-26 18:58

---

![](assets/img_c51ea8e15883.png)
...
 的文件完成。它是 Hermes 的「人格文件」。你在里面写清楚角色定位、工作方式、沟通风格，Hermes 每次对话都会先读这个文件。
...
**操作：** 把选好的角色文件内容复制到 Hermes 配置目录下的 

```
SOUL.md
```

。下次启动 Hermes 时它就会按这个身份工作。
...
，向导会自动装依赖。然后去 Hindsight 控制台[5] 注册，拿一个免费的 API Key，填进去。
...
RTK[13]：Rust 写的 Token 压缩器。它拦截终端命令的输出，过滤掉噪音，只把有用的信息传给 Hermes。一个 

```
ls
```

 命令的输出可能有几百行，RTK 压完只剩关键信息。实测能减少 60-90% 的 Token 消耗[14]。

```
brew install rtkrtk init -g
```
