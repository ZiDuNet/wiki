> 📎 来源: [code秘密花园](https://mp.weixin.qq.com/s?__biz=Mzk0MDMwMzQyOA==&mid=2247505820&idx=1&sn=bab9af17e6dcdfb263f2634c8c211921&chksm=c3440bebc3d97ccad35ab2ffb06fcf5ef08378ab997979a7ff8bef5b150af4ca57454b06755c&mpshare=1&scene=1&srcid=0429gHbKCx3cAqMLNvdPFnTO&sharer_shareinfo=c1097ff0c14b285451f0393bc811efe2&sharer_shareinfo_first=c1097ff0c14b285451f0393bc811efe2) | 时间: 2026-04-29 03:36
...
```
此技能将 Agent 定位为顶尖的设计工程师，可以创造优雅、精致的 Web 作品。核心理念：目标直指"惊艳"，远超"能用"的底线。每个像素都有意义，每个交互都经过深思熟虑。
```
...
```
没有图标、图片、组件时，画占位符比硬画假图更专业。- 图标缺失 → 方块 + 标签（如 [icon]、▢）- 头像缺失 → 首字母圆形色块- 图片缺失 → 带 ratio 信息的占位卡- Logo 缺失 → 品牌名文字 + 简单几何形占位符传递的信号是"这里需要真材料"。假图传递的信号是"我糊弄完了"。
```
...
![](assets/img_b05239b94297.jpg)

整体观感已经很不错了 — 深色背景、发光效果、渐变文字，太空感是有的。

但仔细看，有几个典型的"AI 设计"痕迹：

![](assets/img_c92cdb1bef29.png)
...
![](assets/img_dd8c7ff7202c.jpg)

**配色体系完全不同。** 用了 oklch 色彩空间定义整套色彩系统 — 
...
![](assets/img_bb7d148fe7bd.jpg)

**排版手法更成熟。** 标题用了文字逐行入场动画（
...
![](assets/img_284dee5435e2.jpg)

**细节更精致。** 导航栏 logo 是三个同心圆 + 一个 ember 色小圆点（用 CSS 
...
![](assets/img_a2f1b1e2a241.png)

这次没有了足够的背景信息，虽然效果还不错，但 AI 味就有点重了：

![](assets/img_6b05c9db180c.jpg)

1. 烂大街的深色霓虹调性 背景用纯黑或深灰，再用青蓝色或紫粉色的高饱和度发光阴影勾勒边框和文字。这是 AI 最常用的手段。

![](assets/img_6f96f9439657.jpg)

2. 卡片和导航栏大量使用半透明背景。

![](assets/img_93032519ea4a.jpg)
...
![](assets/img_d31dd0a3af5d.png)

然后再看看最终实现的效果：

它虚构了一个名为 Mira Høst 的北欧摄影师，为她设计了一整套视觉系统：

![](assets/img_d13401c65e48.jpg)
...
![](assets/img_5921a177871a.jpg)

- **字体：** Instrument Serif（展示标题）+ Space Grotesk（界面元素）。Instrument Serif 的斜体被大量用于营造优雅感。

![](assets/img_77c433221fd8.png)

- **布局语言：** 杂志编排式的。左右两侧有固定的竖排文字（"Issue 07 · MMXXV" 和 "© Mira Høst Studio"），用 
